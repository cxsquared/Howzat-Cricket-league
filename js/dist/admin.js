...
flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.initializers.add('cxsquared/howzat-cricket-league', function () {
  ...
  flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.extensionSettings['cxsquared-howzat-cricket-league'] = function () {
    flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.modal.show(SettingsModal, {
      title: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.admin.title'),
      type: 'small',
      items: function items(s) {
        return [m("div", {
          className: "Forum-group"
        }, m(NumberItem, {
          label: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.admin.headings.bot_id'),
          name: "hcl.bot-id",
          setting: s
        }), m(NumberItem, {
          label: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.admin.headings.player_tag_id'),
          name: "hcl.player-tag-id",
          setting: s
        }), m(NumberItem, {
          label: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.admin.headings.captain_group_id'),
          name: "hcl.captain-group-id",
          setting: s
        }), m(NumberItem, {
          label: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.admin.headings.league_movement_tag_id'),
          name: "hcl.league-movements-tag-id",
          setting: s
        }), m(NumberItem, {
          label: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.admin.headings.retirement_tag_id'),
