...
/***/ "./src/forum/components/teams/MakeCaptainModal.js":
/*!********************************************************!*\
  !*** ./src/forum/components/teams/MakeCaptainModal.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MakeCaptainModal; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
...
var MakeCaptainModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(MakeCaptainModal, _Modal);

  function MakeCaptainModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = MakeCaptainModal.prototype;
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.saving = false;
    this.loading = false;
    this.team = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_2___default()();
    this.loadTeams();
  };
  ...
  _proto.content = function content() {
    ...
    if (this.loading) return m(flarum_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_6___default.a, null);
    return m("div", {
      className: "Modal-body"
    }, m(flarum_components_Select__WEBPACK_IMPORTED_MODULE_5___default.a, {
      options: this.teams,
      value: this.team(),
      onchange: function onchange(v) {
        _this.team(v);
      ...
      loading: this.saving,
      disabled: this.saving
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.basics.submitt'))));
  };
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    e.preventDefault();
    this.saving = true;
    var team = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.getById('teams', this.team());
    var data = {};

    if (this.attrs.captain) {
      data.relationships = {
        gmUser: [this.attrs.user]
      };
    } else {
      data.relationships = {
        agmUser: [this.attrs.user]
      };
    }
  ...
  _proto.loadTeams = function loadTeams() {
    ...
    this.loading = true;
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.find('teams').then(function (results) {
      results.forEach(function (team) {
        _this3.teams[team.id()] = team.name();
      });
...
/* harmony import */ var flarum_components_HeaderPrimary__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! flarum/components/HeaderPrimary */ "flarum/components/HeaderPrimary");
/* harmony import */ var flarum_components_HeaderPrimary__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(flarum_components_HeaderPrimary__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! flarum/components/LinkButton */ "flarum/components/LinkButton");
/* harmony import */ var flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var flarum_components_UserPage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! flarum/components/UserPage */ "flarum/components/UserPage");
/* harmony import */ var flarum_components_UserPage__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(flarum_components_UserPage__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var flarum_components_SessionDropdown__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! flarum/components/SessionDropdown */ "flarum/components/SessionDropdown");
/* harmony import */ var flarum_components_SessionDropdown__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(flarum_components_SessionDropdown__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! flarum/components/NotificationGrid */ "flarum/components/NotificationGrid");
/* harmony import */ var flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _models_Player__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./models/Player */ "./src/forum/models/Player.js");
/* harmony import */ var _models_Update__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./models/Update */ "./src/forum/models/Update.js");
/* harmony import */ var _models_Team__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./models/Team */ "./src/forum/models/Team.js");
/* harmony import */ var _models_PlayerMovement__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./models/PlayerMovement */ "./src/forum/models/PlayerMovement.js");
/* harmony import */ var _components_players_PlayerUserPage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/players/PlayerUserPage */ "./src/forum/components/players/PlayerUserPage.js");
/* harmony import */ var _components_players_PlayerCreatePage__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/players/PlayerCreatePage */ "./src/forum/components/players/PlayerCreatePage.js");
/* harmony import */ var _components_players_PlayerDirectoryPage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/players/PlayerDirectoryPage */ "./src/forum/components/players/PlayerDirectoryPage.js");
/* harmony import */ var _components_updates_UpdateCreateModal__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/updates/UpdateCreateModal */ "./src/forum/components/updates/UpdateCreateModal.js");
/* harmony import */ var _components_updates_UpdateDirectoryPage__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/updates/UpdateDirectoryPage */ "./src/forum/components/updates/UpdateDirectoryPage.js");
/* harmony import */ var _notifications_UpdateApprovedNotification__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./notifications/UpdateApprovedNotification */ "./src/forum/notifications/UpdateApprovedNotification.js");
/* harmony import */ var _notifications_UpdateDeniedNotification__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./notifications/UpdateDeniedNotification */ "./src/forum/notifications/UpdateDeniedNotification.js");
/* harmony import */ var _components_updates_UpdatesUserPage__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/updates/UpdatesUserPage */ "./src/forum/components/updates/UpdatesUserPage.js");
/* harmony import */ var _components_teams_TeamsPage__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/teams/TeamsPage */ "./src/forum/components/teams/TeamsPage.js");
/* harmony import */ var _components_teams_MakeCaptainModal__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./components/teams/MakeCaptainModal */ "./src/forum/components/teams/MakeCaptainModal.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('cxsquared/howzat-cricket-league', function () {
  // New Models
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.store.models.players = _models_Player__WEBPACK_IMPORTED_MODULE_13__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.store.models.updates = _models_Update__WEBPACK_IMPORTED_MODULE_14__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.store.models.teams = _models_Team__WEBPACK_IMPORTED_MODULE_15__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.store.models.playerMovements = _models_PlayerMovement__WEBPACK_IMPORTED_MODULE_16__["default"]; // New Model Relationships
  ...
  flarum_models_User__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.gmTeam = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasOne('gmTeam');
  flarum_models_User__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.agmTeam = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasOne('agmTeam'); // New Routes

  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['players'] = {
    path: '/players',
    component: _components_players_PlayerDirectoryPage__WEBPACK_IMPORTED_MODULE_19__["default"]
  };
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['player.create'] = {
    path: '/player/create',
    component: _components_players_PlayerCreatePage__WEBPACK_IMPORTED_MODULE_18__["default"]
  };
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['user.player'] = {
    path: '/u/:username/player',
    component: _components_players_PlayerUserPage__WEBPACK_IMPORTED_MODULE_17__["default"]
  };
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['user.updates'] = {
    path: '/u/:username/updates',
    component: _components_updates_UpdatesUserPage__WEBPACK_IMPORTED_MODULE_24__["default"]
  };
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['updates'] = {
    path: '/updates',
    component: _components_updates_UpdateDirectoryPage__WEBPACK_IMPORTED_MODULE_21__["default"]
  };
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['teams'] = {
    path: '/teams',
    component: _components_teams_TeamsPage__WEBPACK_IMPORTED_MODULE_25__["default"]
  };
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_UserPage__WEBPACK_IMPORTED_MODULE_9___default.a.prototype, 'navItems', function (items) {
    var playersHref = flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.route('user.player', {
      username: this.user.username()
    });
    items.add('players', m(flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a, {
      href: playersHref,
      icon: "fas fa-hiking",
    ...
    items.add('updates', m(flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a, {
      href: updatesHref,
      icon: "fas fa-certificate",
      "class": "Button Button--link hasIcon"
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_HeaderPrimary__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'items', function (items) {
    ...
    if (player) {
      ...
      items.add('view-players', m(flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a, {
        href: href,
      ...
      items.add('create-players', m(flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a, {
        href: _href,
        className: "LinksButton Button Button--link"
      }, flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('hcl.forum.nav.players_create')), 5);
    }

    items.add('claimTpe', m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
      className: "LinksButton Button Button--link",
      onclick: function onclick() {
        return flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.modal.show(_components_updates_UpdateCreateModal__WEBPACK_IMPORTED_MODULE_20__["default"]);
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('hcl.forum.nav.claim_tpe')));
  }); // Claim Comment

  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_utils_PostControls__WEBPACK_IMPORTED_MODULE_5___default.a, 'userControls', function (items, post) {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_utils_UserControls__WEBPACK_IMPORTED_MODULE_4___default.a, 'moderationControls', function (items, user) {
    if (flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('adminUrl')) {
      items.add('hcl.gm', m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_SessionDropdown__WEBPACK_IMPORTED_MODULE_11___default.a.prototype, 'items', function (items) {
    if (flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('canEditUpdates')) {
      items.add('updates', flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a.component({
        icon: 'fas fa-pen',
  ...
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.notificationComponents.updateApproved = _notifications_UpdateApprovedNotification__WEBPACK_IMPORTED_MODULE_22__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.notificationComponents.updateDenied = _notifications_UpdateDeniedNotification__WEBPACK_IMPORTED_MODULE_23__["default"];
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_12___default.a.prototype, 'notificationTypes', function (items) {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_10___default.a.prototype, 'navItems', function (items) {
