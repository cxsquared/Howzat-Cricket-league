...
var UpdateTypeUtils = /*#__PURE__*/function () {
  ...
  UpdateTypeUtils.types = function types() {
    return {
      ...
      simAttendance: flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('hcl.forum.updates.types.simAttendance'),
...
/* harmony import */ var _PlayerUpdateModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./PlayerUpdateModal */ "./src/forum/components/players/PlayerUpdateModal.js");
...
var PlayerCard = /*#__PURE__*/function (_Component) {
  ...
  _proto.toggleUpdating = function toggleUpdating() {
    flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.modal.show(_PlayerUpdateModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
      player: this.player,
  ...
  _proto.buildHeader = function buildHeader(player) {
    ...
    var usernameSpan = flarum_helpers_username__WEBPACK_IMPORTED_MODULE_6___default()(user);
    var userLink = null;
    ...
    }, Object(_common_utils_flag__WEBPACK_IMPORTED_MODULE_7__["default"])(player.nationality().toLowerCase()));
    var team = null;

    if (player.team()) {
      team = [m("div", {
        className: "PlayerCard-data PlayerCard-team"
      }, m(flarum_components_Link__WEBPACK_IMPORTED_MODULE_5___default.a, {
        href: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.route('teams.show', {
          id: player.team().id()
        }),
        ...
        alt: player.team().name(),
        style: {
          backgroundColor: "" + color__WEBPACK_IMPORTED_MODULE_1___default()("#" + player.team().primaryColor()).darken(0.35).hex()
        }
      }))), seperator];
    }
    ...
    return m("div", {
      ...
      className: "PlayerCard-data"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.forum.player.tpa') + ": " + player.tpa()), seperator, m("div", {
      className: "PlayerCard-data"
    }, "" + flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('hcl.forum.player.season') + player.season()))), m("div", {
...
/***/ "./src/forum/components/players/PlayerRetireModal.js":
/*!***********************************************************!*\
  !*** ./src/forum/components/players/PlayerRetireModal.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PlayerRetireModal; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
...
var PlayerRetireModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PlayerRetireModal, _Modal);

  function PlayerRetireModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = PlayerRetireModal.prototype;
  ...
  _proto.title = function title() {
    return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.retire.title');
  };
  ...
  _proto.content = function content() {
    ...
    }, m("h2", null, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.retire.warning')), m("div", {
    ...
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.basics.cancel')), m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a, {
      type: "submit",
      className: "Button Button--danger",
      loading: this.saving,
      disabled: this.saving
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.retire.button'))));
  };
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    this.attrs.player.save({
      ...
      flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.alerts.show({
        type: 'success'
      }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.alerts.player_retired'));

      if (_this2.attrs.showPlayer) {
        _this2.attrs.showPlayer(null);
      }
    })["catch"](function () {
      _this2.saving = false;
    });
...
/* harmony import */ var flarum_components_Button__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! flarum/components/Button */ "flarum/components/Button");
/* harmony import */ var flarum_components_Button__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(flarum_components_Button__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _PlayerRetireModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./PlayerRetireModal */ "./src/forum/components/players/PlayerRetireModal.js");
...
var PlayerUserPage = /*#__PURE__*/function (_UserPage) {
  ...
  _proto.content = function content() {
    ...
    if (this.user === flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user || flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('adminUrl')) {
      retire = m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_7___default.a, {
        className: "Button Button--danger",
        onclick: function onclick() {
          return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(_PlayerRetireModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
            player: _this.player,
            showPlayer: _this.showPlayer.bind(_this)
          });
        }
      }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.retire.button'));
    }
...
/***/ "./src/forum/components/teams/ReleasePlayerModal.js":
/*!**********************************************************!*\
  !*** ./src/forum/components/teams/ReleasePlayerModal.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ReleasePlayerModal; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_components_Modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/components/Modal */ "flarum/components/Modal");
...
var ReleasePlayerModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(ReleasePlayerModal, _Modal);

  function ReleasePlayerModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = ReleasePlayerModal.prototype;
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.saving = false;
    this.loading = false;
    if (this.player.user()) this.loadUpdates();
  };
  ...
  _proto.title = function title() {
    return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.release.title');
  };
  ...
  _proto.content = function content() {
    ...
    if (this.player.user() && this.latestUpdate) {
      text = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.release.warning_update', {
        latestUpdate: this.latestUpdate.weekEnding().toDateString()
      });
    } else {
      text = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.release.warning');
    }

    return m("div", {
      className: "Modal-body"
    }, m("h2", null, text), m("div", {
      className: "Form-gruop"
    }, m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a, {
      onclick: function onclick() {
        return _this.hide();
      ...
      className: "Button Button--danger",
      loading: this.saving,
      disabled: this.saving || this.saving
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.player.release.button'))));
  };

  _proto.loadUpdates = function loadUpdates() {
    var _this2 = this;

    this.loading = true;
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.find('updates', {
      filter: {
        q: "username:" + this.player.user().username()
      },
      page: {
        limit: 1
      },
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.request({
      url: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('apiUrl') + "/players/" + this.player.id() + "/release",
      method: 'POST'
    }).then(function (p) {
      _this3.hide();
      ...
      flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.alerts.show({
        type: 'success'
      }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('hcl.forum.alerts.player_released'));
...
/* harmony import */ var _ReleasePlayerModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ReleasePlayerModal */ "./src/forum/components/teams/ReleasePlayerModal.js");
...
function playerItem(player, gmView, changeRole, onrelease) {
  ...
  if (gmView) {
    ...
    baseView.push(m("div", null, m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_5___default.a, {
      icon: "fas fa-times",
      className: "Button Button--danger",
      onclick: function onclick() {
        return flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.modal.show(_ReleasePlayerModal__WEBPACK_IMPORTED_MODULE_10__["default"], {
          player: player,
          onexit: onrelease
        });
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.translator.trans('hcl.forum.player.release.button'))));
    liClass += ' TeamCard--gm';
  } else {
...
var TeamCard = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    var style = {
      ...
      backgroundColor: "" + color__WEBPACK_IMPORTED_MODULE_2___default()("#" + this.team.primaryColor()).darken(0.35).hex()
    };
    var save = null;
    ...
    return m("div", {
      ...
      return playerItem(p, _this.gmView, _this.changeRole.bind(_this), _this.onRelease.bind(_this));
    }))), m("div", {
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('cxsquared/howzat-cricket-league', function () {
  ...
  flarum_models_User__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.retiredPlayers = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasMany('retired_players');
  flarum_models_User__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.submittedUpdates = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasMany('submitted_updates');
  flarum_models_User__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.gmTeam = flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasOne('gm_team'); // New Routes
...
Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])(Player.prototype, {
  ...
  season: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute('season'),
  role: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute('role'),
  order: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute('order'),
  // Computed
...
Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])(Team.prototype, {
  ...
  createdAt: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute('createdAt', flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.transformDate),
  updatedAt: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.attribute('updatedAt', flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.transaformDate),
  gmUser: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasOne('gm_user'),
  agmUser: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.hasOne('agm_user'),
...
var PlayersDirectoryState = /*#__PURE__*/function () {
  ...
  _proto.sortMap = function sortMap() {
    return Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, new _common_utils_PlayerSortMap__WEBPACK_IMPORTED_MODULE_1__["default"]().sortMap());
  };
