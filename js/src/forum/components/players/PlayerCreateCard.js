...
export default class PlayerCreateCard extends Component {
    ...
    view() {
        return <div className="Form Form-group Form--centered CreatePlayer">{this.fields().toArray()}</div>;
    }
    ...
    fields() {
        ...
        items.add(
            'identity',
            <FieldSet className="identity" label={app.translator.trans('hcl.forum.player.identity')}>
