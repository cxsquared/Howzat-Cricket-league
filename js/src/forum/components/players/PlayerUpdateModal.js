...
export default class PlayerUpdateModal extends Modal {
    ...
    content() {
        ...
        const tpe = (
            <div className="PlayerUpdate--tpebanked" style={{ backgroundColor: bgColor, color: textColor }}>
                {`${app.translator.trans('hcl.forum.player.update.banked_tpe')}: ${this.player.bankedTpe() - this.spentTpe}`}
            </div>
        );
        const batting = (
            <div className="PlayerUpdate--batting">
                ...
                <div className="PlayerUpdate--skills">
                    <div className="PlayerUpdate--item PlayerUpdate--header">{app.translator.trans('hcl.forum.player.update.skill')}</div>
        ...
        const bowling = (
            <div className="PlayerUpdate--bowling">
                <div className="PlayerUpdate--info">
                    <h2>
        ...
        const reset = (
            <Button type="button" className="Button Button--danger" onclick={() => this.reset()}>
                {app.translator.trans('hcl.forum.basics.reset')}
            </Button>
        );

        return (
            <div className="PlayerUpdate--body Modal-body">
                {tpe}
                {batting}
                {bowling}
    ...
    skillRow(skill, style) {
        ...
        return [
            <div className={className} title={app.translator.trans(`hcl.forum.player.tooltip.${name}`)}>
    ...
    currentTpe(skill, updated) {
        ...
        return <div className={className}>{this.playerSkillUpdates[skill]}</div>;
    }
    ...
    currentCost(skill) {
        ...
        return <div className={className}>{cost}</div>;
    }
    ...
    updateButtons(skill) {
        ...
        return (
            <div className="PlayerUpdate--item PlayerUpdate--buttons PlayerUpdate--center ButtonGroup">
                <Button
                    type="button"
